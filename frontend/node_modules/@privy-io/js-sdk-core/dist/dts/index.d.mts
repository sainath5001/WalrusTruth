...
declare class CrossAppApi {
     ...
     */
    updateOnCrossAppAuthentication(providerAppId: string, tokens: AuthenticatedUser.OAuthTokens): Promise<void>;
    /**
 ...
 */
declare function create(context: WalletApiActionContext, { request }: Input$3): Promise<Wallet>;
