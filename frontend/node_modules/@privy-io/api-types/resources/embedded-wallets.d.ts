 ...
 */
export type SmartWalletConfiguration = SmartWalletConfiguration.Enabled | SmartWalletConfiguration.UnionMember1;
export declare namespace SmartWalletConfiguration {
    interface Enabled {
        enabled: false;
    }
 ...
 */
export type SmartWalletConfigurationInput = SmartWalletConfigurationInput.Enabled | SmartWalletConfigurationInput.UnionMember1;
export declare namespace SmartWalletConfigurationInput {
    interface Enabled {
        enabled: false;
    }
    interface UnionMember1 {
